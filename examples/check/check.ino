...
iarduino_RF433_Transmitter radioTX(4);                    // Создаём объект radioTX для работы с передатчиком, указав номер вывода к которому он подключён.
iarduino_RF433_Receiver    radioRX(3);                    // Создаём объект radioRX для работы с приёмником  , указав номер вывода к которому он подключён.
